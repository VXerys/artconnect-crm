  ...
  return (
    <Card className="bg-card border-border overflow-hidden flex flex-col h-full w-full">
      ...
      <CardContent className="p-0 flex-1 overflow-hidden">
        {contacts.length === 0 ? (
          /* Empty State */
          <div className="flex flex-col items-center justify-center py-10 sm:py-12 md:py-16 px-4 text-center h-full">
            ...
            <h3 className="text-sm sm:text-base font-semibold mb-1 sm:mb-1.5">Belum Ada Kontak</h3>
            <p className="text-[10px] sm:text-xs text-muted-foreground max-w-[200px] sm:max-w-xs">
              Tambahkan kontak pertama Anda untuk membangun jaringan
            </p>
          </div>
        ) : (
          <div 
