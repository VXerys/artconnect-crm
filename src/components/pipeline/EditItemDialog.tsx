        ...
        <div className="grid gap-4 sm:gap-5 py-4 sm:py-5">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <Input
              ...
              className={cn("bg-secondary/50 text-sm", formErrors.title && "border-destructive")}
            />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="space-y-1.5 sm:space-y-2">
              <Label htmlFor="edit-medium" className="text-xs sm:text-sm">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <Label htmlFor="edit-dueDate" className="text-xs sm:text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <Label htmlFor="edit-price" className="text-xs sm:text-sm">Harga (Opsional)</Label>
              <Input
                id="edit-price"
                placeholder="Rp 0"
          ...
          {/* Description */}
          <div className="space-y-1.5 sm:space-y-2">
            <Label htmlFor="edit-desc" className="text-xs sm:text-sm">Deskripsi (Opsional)</Label>
            <Textarea
              id="edit-desc"
