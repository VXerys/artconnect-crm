      ...
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto bg-card border-border">
        ...
        <div className="grid gap-5 py-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="add-title">Judul Karya <span className="text-destructive">*</span></Label>
            <Input
              id="add-title"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="add-medium">Medium <span className="text-destructive">*</span></Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="add-dueDate">Target Tanggal <span className="text-destructive">*</span></Label>
              <Input
                id="add-dueDate"
                type="date"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="add-status">Status Awal</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="add-price">Harga (Opsional)</Label>
              <Input
                id="add-price"
                placeholder="Rp 0"
