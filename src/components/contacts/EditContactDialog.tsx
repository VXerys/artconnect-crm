      ...
      <DialogContent className="w-[95vw] max-w-[550px] max-h-[90vh] overflow-y-auto bg-card border-border p-4 sm:p-6">
        <DialogHeader className="pb-3 sm:pb-4 border-b border-border">
          <DialogTitle className="font-display text-lg sm:text-xl md:text-2xl flex items-center gap-1.5 sm:gap-2">
            <Edit className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-primary" />
            Edit Kontak
          </DialogTitle>
        ...
        <div className="grid gap-3 sm:gap-4 md:gap-5 py-3 sm:py-4 md:py-5">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            <Label htmlFor="edit-name" className="text-xs sm:text-sm">Nama <span className="text-destructive">*</span></Label>
            <Input
              id="edit-name"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="space-y-1.5 sm:space-y-2">
              <Label htmlFor="edit-email" className="text-xs sm:text-sm">Email <span className="text-destructive">*</span></Label>
              <Input
                id="edit-email"
                type="email"
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <Label htmlFor="edit-phone" className="text-xs sm:text-sm">Telepon <span className="text-destructive">*</span></Label>
              <Input
                id="edit-phone"
                type="tel"
          ...
          {/* Website */}
          <div className="space-y-1.5 sm:space-y-2">
            <Label htmlFor="edit-website" className="text-xs sm:text-sm">Website (Opsional)</Label>
            <Input
              id="edit-website"
              type="url"
              placeholder="https://..."
          ...
          {/* Address */}
          <div className="space-y-1.5 sm:space-y-2">
            <Label htmlFor="edit-address" className="text-xs sm:text-sm">Alamat (Opsional)</Label>
            <Input
              id="edit-address"
        ...
        <DialogFooter className="pt-3 sm:pt-4 border-t border-border gap-2 sm:gap-3 flex-col-reverse sm:flex-row">
          ...
          <Button 
            onClick={onSubmit} 
            disabled={isSubmitting} 
            className="gap-1.5 sm:gap-2 min-w-[100px] sm:min-w-[120px] shadow-glow h-9 sm:h-10 text-xs sm:text-sm w-full sm:w-auto"
          >
            {isSubmitting ? (
              <>
